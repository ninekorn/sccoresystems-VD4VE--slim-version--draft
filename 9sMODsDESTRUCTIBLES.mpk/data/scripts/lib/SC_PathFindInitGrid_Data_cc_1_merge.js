...
var SC_PathFindInitGrid_Data_cc_1_merge =
{
    npcGetGridDataMerged: function (gridWorldSize, nodeRadius, indexOfGrid, cData, noder, isStationTile) {
        ...
        /*if (stationTilesArray[cData.iop] != null) {
            ...
            someDataToReturn = SC_PathFindInitGrid_cc_1.npcBuildGrid(gridWorldSize, nodeRadius, indexOfGrid, cData, noder, stationTilesArray[cData.iop]);
        }
        else // station tiles == null so the pathfind is for something different than trying to get to the station entrance.
        {
            someDataToReturn = SC_PathFindInitGrid_cc_1.npcBuildGrid(gridWorldSize, nodeRadius, indexOfGrid, cData, noder, null);
        }*/
        ...
        if (initialPathfindStartingPos[globIndex] == null || cData.sSwtc == 2) {
            ...
            if (cData == null || cData.nData == null || cData.nData.nCoord == null) {
                //---console.PrintError("null0 SC_PathFindInitGrid_Data_cc_1_merge.js");
            }
        ...
        if (initialPathfindTargetPos[globIndex] == null || cData.sSwtc == 3) {
            ...
            if (cData.sSwtc == 3) {
                //---console.PrintError("sSwtc == 3  SC_PathFindInitGrid_Data_cc_1_merge.js");
                ...
                if (cData == null || cData.nData == null || cData.nData.nCoord == null) {
                    //---console.PrintError("null1 SC_PathFindInitGrid_Data_cc_1.js");
                }
        ...
        for (var x = -gridSizeXL; x <= gridSizeXR; x++) {
            for (var y = -gridSizeYB; y <= gridSizeYT; y++) {
                ...
                {
                    //---console.PrintError("### the initial position is the same as the target position. this pathfind was started with missing logic prior to this function call, for this scenario to not even arrive to this point maybe... checking. SC_PathFindInitGrid_Data_cc_1_merge.js");
