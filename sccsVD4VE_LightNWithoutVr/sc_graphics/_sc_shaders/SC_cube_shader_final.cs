...
namespace SCCoreSystems.SC_Graphics
{
    public class SC_cube_shader_final                 // 228 lines
    {
        ...
        public SCCoreSystems.SC_Graphics.SC_cube.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, SCCoreSystems.SC_Graphics.SC_cube.DLightBuffer[] DLightBuffer)
        {
