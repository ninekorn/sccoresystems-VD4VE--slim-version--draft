...
{
    public class SC_containment_grid_shader_final                 // 228 lines
    {
        ...
        public SC_containment_grid_shader_final() 
        {
        ...
        public SCCoreSystems.SC_Graphics.sc_containment_grid.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, SCCoreSystems.SC_Graphics.sc_containment_grid.DLightBuffer[] DLightBuffer)
        {
        ...
        public bool Render(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, sc_containment_grid.DLightBuffer[] _DLightBuffer_, sc_containment_grid _cuber)
        {
        ...
        private void RenderShader(DeviceContext deviceContext, sc_containment_grid.DLightBuffer[] _DLightBuffer_, sc_containment_grid _cuber)
        {
