...
namespace SCCoreSystems.SC_Graphics
{
    public class sc_voxel_shader_final                 // 228 lines
    {
        ...
        public SCCoreSystems.SC_Graphics.sc_voxel.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, SCCoreSystems.SC_Graphics.sc_voxel.DLightBuffer[] DLightBuffer)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                */
                ...
                {
                    vsFileName = SCCoreSystems.Properties.Resources.texture_voxel1;// "../../../_sc_instance_shader/" + "texture.vs";
                    psFileName = SCCoreSystems.Properties.Resources.texture_voxel;// "../../../_sc_instance_shader/" + "texture.ps";
