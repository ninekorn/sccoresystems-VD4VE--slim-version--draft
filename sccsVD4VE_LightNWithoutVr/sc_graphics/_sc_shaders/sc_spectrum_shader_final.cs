...
{
    public class sc_spectrum_shader_final// 228 lines
    {
        ...
        public sc_spectrum_shader_final()
        {
        ...
        public sccsVD4VE_LightNWithoutVr.SC_Graphics.sc_spectrum.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, sccsVD4VE_LightNWithoutVr.SC_Graphics.sc_spectrum.DLightBuffer[] DLightBuffer)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                */
                ...
                {
                    vsFileName = sccsVD4VE_LightNWithoutVr.Properties.Resources.texture1;// "../../../_sc_instance_shader/" + "texture.vs";
                    psFileName = sccsVD4VE_LightNWithoutVr.Properties.Resources.texture;// "../../../_sc_instance_shader/" + "texture.ps";
                    var gsFileName = sccsVD4VE_LightNWithoutVr.Properties.Resources.HLSL;
        ...
        public bool Render(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, sc_spectrum.DLightBuffer[] _DLightBuffer_, sc_spectrum _cuber)
        {
        ...
        private void RenderShader(DeviceContext deviceContext, sc_spectrum.DLightBuffer[] _DLightBuffer_, sc_spectrum _cuber)
        {
