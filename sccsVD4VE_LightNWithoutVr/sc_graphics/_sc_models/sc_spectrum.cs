...
namespace sccsVD4VE_LightNWithoutVr.SC_Graphics
{
    public class sc_spectrum : ITransform, IComponent
    {
        ...
        public sccsVD4VE_LightNWithoutVr.SC_Graphics.sc_spectrum.DInstanceData[] instancesDataRIGHT { get; set; }
        public sccsVD4VE_LightNWithoutVr.SC_Graphics.sc_spectrum.DInstanceData[] instancesDataUP { get; set; }
        ...
        public sc_spectrum_shader_final _this_object_texture_shader { get; set; }

        DLightBuffer[] _DLightBuffer = new DLightBuffer[1];

        public sc_spectrum_instances[] _arrayOfInstances;// { get; set; }
        ...
        public sc_spectrum_instances _singleObjectOnly;
        ...
        public sc_spectrum() { }
        public sccsVD4VE_LightNWithoutVr.sc_console.SC_console_directx.BodyTag _tag;
        public bool Initialize(sccsVD4VE_LightNWithoutVr.sc_console.SC_console_directx D3D, int width, int height, float tileSize, int divX, int divY, float _sizeX, float _sizeY, float _sizeZ, Vector4 color, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int isTerrain, float offsetPosX, float offsetPosY, float offsetPosZ, World the_world, sccsVD4VE_LightNWithoutVr.sc_console.SC_console_directx.BodyTag tag, bool is_static, int addtoworld, float mass, float vertoffsetx, float vertoffsety, float vertoffsetz)
        {
        ...
        private bool InitializeBuffer(sccsVD4VE_LightNWithoutVr.sc_console.SC_console_directx D3D, float _sizeX, float _sizeY, float _sizeZ, float tileSize, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int type_of_cube, float offsetPosX, float offsetPosY, float offsetPosZ, float vertoffsetx, float vertoffsety, float vertoffsetz)
        {
            try
            {
                int tessellation = 3;
                ...
                _arrayOfInstances = new sc_spectrum_instances[instX * instY * instZ];
                    ...
                    for (int y = 0; y < instY; y++)
                    {
                        for (int z = 0; z < instZ; z++)
                        {
                            if (type_of_cube == 0)
                            {
                                ...
                                sc_spectrum_instances _cube = new sc_spectrum_instances();
