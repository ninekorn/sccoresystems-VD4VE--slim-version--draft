...
namespace SCCoreSystems.SC_Graphics
{
    public class sc_voxel : ITransform, IComponent
    {
        ...
        public SCCoreSystems.SC_Graphics.sc_voxel.DInstanceData[] instancesDataRIGHT { get; set; }
        public SCCoreSystems.SC_Graphics.sc_voxel.DInstanceData[] instancesDataUP { get; set; }
