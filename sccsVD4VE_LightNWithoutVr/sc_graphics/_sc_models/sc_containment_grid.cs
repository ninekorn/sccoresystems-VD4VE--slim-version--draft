...
{
    public class sc_containment_grid : ITransform, IComponent
    {
        /// <summary>
        ...
        public SCCoreSystems.SC_Graphics.sc_containment_grid.DInstanceData[] instancesDataRIGHT { get; set; }
        public SCCoreSystems.SC_Graphics.sc_containment_grid.DInstanceData[] instancesDataUP { get; set; }
        ...
        public SC_containment_grid_shader_final _this_object_texture_shader { get; set; }

        DLightBuffer[] _DLightBuffer = new DLightBuffer[1];

        public sc_containment_grid_instances[] _arrayOfInstances;// { get; set; }
        ...
        public sc_containment_grid_instances _singleObjectOnly;
        ...
        private bool InitializeBuffer(SCCoreSystems.sc_console.SC_console_directx D3D, float _sizeX, float _sizeY, float _sizeZ, float tileSize, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int type_of_cube, float offsetPosX, float offsetPosY, float offsetPosZ, float vertoffsetx, float vertoffsety, float vertoffsetz)
        {
            try
            {
                ...
                if (type_of_cube == 2 || type_of_cube == 0 || type_of_cube == 4 || type_of_cube == 5 || type_of_cube == 3)
                {
                    Vertices = new[]
                    {                                   
                    //TOP
                ...
                _arrayOfInstances = new sc_containment_grid_instances[instX * instY * instZ];
                    ...
                    for (int y = 0; y < instY; y++)
                    {
                        for (int z = 0; z < instZ; z++)
                        {
                            if (type_of_cube == 0)
                            {
                                ...
                                sc_containment_grid_instances _cube = new sc_containment_grid_instances();
                            ...
                            else if (type_of_cube == 2) // VOXEL HUMAN RIG 
                            {
                                ...
                                if (_addtoworld == 1)
                                {
                                    _cube.transform.Component.rigidbody = new RigidBody(new BoxShape((_sizeX * 2) + (1*0.00123f), (_sizeY * 2) + (1 * 0.00123f), (_sizeZ * 2) + (1 * 0.00123f)));
                                    _cube.transform.Component.rigidbody.Position = new Jitter.LinearMath.JVector(_tempMatrix.M41, _tempMatrix.M42, _tempMatrix.M43);
                                    _cube.transform.Component.rigidbody.Orientation = Conversion.ToJitterMatrix(_tempMatrix);
                                    _cube.transform.Component.rigidbody.LinearVelocity = new Jitter.LinearMath.JVector(0, 0, 0);
                                    _cube.transform.Component.rigidbody.IsStatic = _is_static;
                            ...
                            else if (type_of_cube == 6) // capsule
                            {
                                ...
                                if (_addtoworld == 1)
                                {
                                    ...
                                    _cube.transform.Component.rigidbody = new RigidBody(new CapsuleShape((length * 0.1f) + (1 * 0.00123f), radius + (1 * 0.00123f)));
                            ...
                            else if (type_of_cube == 7) //cone
                            {
                                ...
                                if (_addtoworld == 1)
                                {
                                    ...
                                    _cube.transform.Component.rigidbody = new RigidBody(new ConeShape((height * 3 + (1 * 0.00123f)), (radius * 3) + (1* 0.00123f)));
                                    _cube.transform.Component.rigidbody.Position = new Jitter.LinearMath.JVector(_tempMatrix.M41, _tempMatrix.M42, _tempMatrix.M43);
                                    _cube.transform.Component.rigidbody.Orientation = Conversion.ToJitterMatrix(_tempMatrix);
                                    _cube.transform.Component.rigidbody.LinearVelocity = new Jitter.LinearMath.JVector(0, 0, 0);
                                    _cube.transform.Component.rigidbody.IsStatic = _is_static;
                            ...
                            else if (type_of_cube == 8)
                            {
                                ...
                                if (_addtoworld == 1)
                                {
                                    //_cube.transform.Component.rigidbody = new RigidBody(new BoxShape(_sizeX * 2 * 1.01f, _sizeY * 2 * 1.01f, _sizeZ * 2 * 1.01f));
                                    //_cube.transform.Component.rigidbody = new RigidBody(new CapsuleShape(_sizeX * 50 * 0.5f, tileSize * 0.5f * 0.5f));
                                    _cube.transform.Component.rigidbody = new RigidBody(new CylinderShape((height * 2 )+ (1 * 0.00123f), (radius) + (1 * 0.00123f)));
